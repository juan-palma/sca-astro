/*::::::::::: Juan Palma (2025) :::::::::::*/
// estilos:
import '@/assets/css/reset-sanatize-normalize-boilerplate-min.css';
import '@/assets/css/main.css';
//import * as styles from '@/assets/css/main.css';
// Librerías locales (equivalentes a tus paths antiguos)
//import Modernizr from '@l/modernizr';       // Antes: "l/modernizr"
import Precarga from '@l/precarga';         // Antes: "l/precarga"
import createHeroSlider from '@l/slider';            // Antes: "l/slider"
import { initVideos } from '@l/buildVideo';     // Antes: "l/buildVideo"

// FontAwesome (ahora desde npm)
//import { library } from '@fortawesome/fontawesome-svg-core';
//import { faWhatsapp, faFacebook, faLinkedin } from '@fortawesome/free-brands-svg-icons';
//import { faBars, faXmark } from '@fortawesome/free-solid-svg-icons';

// Inicialización de FontAwesome
//library.add(faWhatsapp, faFacebook, faLinkedin, faBars, faXmark);
...
async function cargaPrimaria(){
	try {
		...
		//await pantallasShow();
		window.sliderDefaultDelay = 8000;   // 5 s default
